          ...
          <div class="menu-sidebar__content js-scrollbar1">
            ...
            <div class="page-container">
              ...
              <div class="main-content">
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="table-responsive m-b-40">
                      <table class="table table-borderless table-striped table-earning" id= "table-id">
                        <thead>
                          <tr>
                            <th style="width: 25%" onclick="sortTable(1)" >Nama <label class="fa fa-caret-down"></label></th>
                            <th style="width: 17.5%">No HP </th>
                            <th style="width: 17.5%">Nama Media</th>
                ...
                <script src="Assets/data/js/js.js"></script>
